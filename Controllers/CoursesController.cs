...
public async Task<IActionResult> Details(long? id)
        ...
        public async Task<IActionResult> Create([Bind("CoursesId,CourseName,CourseDescroption,FacilitatorName")] Courses courses)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("CoursesId,CourseName,CourseDescroption,FacilitatorName")] Courses courses)
        {
